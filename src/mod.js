...
class ArcaLive_ReTeX {
    postDBLoad(container) {
        ...
        const scope_mounts = items.filter(x => itemHelper.isOfBaseclass(x._id, BaseClasses_1.BaseClasses.MOUNT));
        const receivers = items.filter(x => itemHelper.isOfBaseclass(x._id, BaseClasses_1.BaseClasses.RECEIVER));
